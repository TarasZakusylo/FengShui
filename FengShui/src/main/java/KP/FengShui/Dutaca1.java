...
public class Dutaca1 extends JFrame {
	...
	public Dutaca1(final String s_choice1, final String s_choice2, final String s_choice3, final String s_choice4,
		...
		b_Dali.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if (i_putanna1 == 0 || i_putanna2 == 0 || i_putanna3 == 0 || i_putanna4 == 0 || i_putanna5 == 0
					...
					new DutacaRezultaty(s_choice1, s_choice2, s_choice3, s_choice4, s_choice5, s_choice6, s_choice7,
		...
		JLabel label = new JLabel("У дитячій є якісь плакати, постери ?");
		...
		JLabel label_1 = new JLabel("У дитячій є дзеркало ?");
		...
		JLabel label_2 = new JLabel("Чи є у дитячій кімнатні рослини ?");
		...
		JLabel label_3 = new JLabel("Чи є у дитячій ніші, балки, виступи ?");
		...
		JLabel label_4 = new JLabel("Чи знаходиться туалет поряд із дитячою ?");
		...
		JLabel label_5 = new JLabel("Чи є у дитячій телевізор чи комп’ютер ?");
		...
		JLabel label_6 = new JLabel("У Вашої дитини є грамоти ?");
