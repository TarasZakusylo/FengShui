...
public class Korudor1 extends JFrame {
	...
	public Korudor1(final String s_Bagua, final int i_Gua1, final int i_Gua2, final int i_Gua3, final int i_Gua4,
			final int i_Gua5, final int i_Gua6, final String s_choice1, final String s_choice2, final String s_choice3,
		...
		JLabel label = new JLabel("У Вас туалет знаходиться поряд із вхідними дверима ?");
		...
		JLabel label_1 = new JLabel("У Вашому коридорі (прихожій) є сходи ?");
		...
		JLabel label_2 = new JLabel("У Вашому коридорі є вікна ?");
		...
		JLabel label_3 = new JLabel("Вхідні двері розташовані навпроти сходового майданчика?");
		...
		JLabel label_4 = new JLabel("Чи цікавий Вам захист у стилі феншуй ?");
		...
		JLabel label_5 = new JLabel("Чи зберігаєте Ви ззовні дверей якісь речі ?");
		...
		JLabel label_6 = new JLabel("Чи є у Вас дзеркало у коридорі ?");
