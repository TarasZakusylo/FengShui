...
public class Spalna1 extends JFrame {
	...
	public Spalna1(final String s_choice1, final String s_choice2, final String s_choice3, final String s_choice4,
		...
		b_Dali.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if (i_putanna1 == 0 || i_putanna2 == 0 || i_putanna3 == 0 || i_putanna4 == 0 || i_putanna5 == 0
					...
					new SpalnaRezultaty(s_choice1, s_choice2, s_choice3, s_choice4, s_choice5, s_choice6, s_choice7,
		...
		JLabel label = new JLabel("Чи є щось на стінах Вашої стальні ?");
		...
		JLabel label_1 = new JLabel("Чи є у Вашій спальні телевізор, комп’ютер ?");
		...
		JLabel label_2 = new JLabel("Чи є поряд із дверима якісь меблі ?");
		...
		JLabel label_3 = new JLabel("Чи є у Вашій спальні книги ?");
		...
		JLabel label_4 = new JLabel("У Вашій спальні є люстра ?");
		...
		JLabel label_5 = new JLabel("У Вас двоспальне ліжко ?");
		...
		JLabel label_6 = new JLabel("Чи є у Вашій спальні кімнатні рослини ?");
